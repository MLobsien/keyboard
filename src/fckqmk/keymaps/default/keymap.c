...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [NUMBERS] =
        LAYOUT(KC_1, KC_2, KC_3, KC_4, KC_5, _______, _______, KC_6, KC_7, KC_8,
               ...
               OSL(SOUNDS), _______, _______, _______, _______, _______,
               _______, _______, _______, _______, _______, _______, _______,
               _______, _______, _______, _______, _______, _______),

    [VIM_COMPATIBILITY] = LAYOUT(
        _______, NEXT_WORD, _______, REDO, _______, _______, _______,
        COPY_SELECT, UNDO, _______, _______, PASTE, _______, _______, _______,
        _______, START_END, TG(VIM_COMPATIBILITY), _______, MOVE_CURSOR_LEFT,
        MOVE_CURSOR_DOWN, MOVE_CURSOR_UP, MOVE_CURSOR_RIGHT, _______, _______,
        CUT, _______, VISUAL_TOGGLE, PREVIOUS_WORD, _______, _______,
        SELECT_NEXT, _______, _______, _______, _______),
